...
//////////////////////////////////////////////////////////////////////////////////////////////////
#define AP_RENDER(...) EXPAND(RENDER_IMPL_A(__VA_ARGS__, 6, 5, 4, 3, 2, 1, 0))
...
#define RENDER_IMPL_B(code, N, ...) \
	do{\
		...
		{\
			auto mem = ::Apate::Renderer::Submit(HZ_RENDER_UNIQUE_HZR::HZ_EXECUTE_FUNCTION, sizeof(HZ_RENDER_UNIQUE_HZR));\
			new (mem) HZ_RENDER_UNIQUE_HZR(EXPAND(FOR_EACH_##N(DECL_IDENT, NONE, COMMA, __VA_ARGS__)));\
		}\
	}while(0)


#define RENDER_S(...) auto self = this;\
	RENDER(self, __VA_ARGS__)
